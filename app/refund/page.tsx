                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-8">
                    ...
                    <div className="prose prose-neutral max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-neutral-700 mb-4">
                                To request a refund, please contact us at <a href="mailto:support@bulktok.com" className="text-primary-600 hover:underline">support@bulktok.com</a> with:
                            </p>
                            <ul className="list-disc list-inside text-neutral-700 space-y-2 mb-4">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-neutral-700">
                                For refund requests or questions, contact: <a href="mailto:support@bulktok.com" className="text-primary-600 hover:underline">support@bulktok.com</a>
                            </p>
                        </section>
                    </div>
                </div>
